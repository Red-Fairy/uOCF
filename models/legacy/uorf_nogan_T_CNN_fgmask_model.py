...
from .model_T_sam_fgmask import Decoder, SlotAttention
from .model_general import Encoder
from .utils import *

import torchvision

class uorfNoGanTCNNFGMaskModel(BaseModel):
    ...
    def forward(self, epoch=0):
        ...
        # Slot Attention
        use_mask = False
        z_slots, fg_slot_position, attn = self.netSlotAttention(feat, self.masks, use_mask=use_mask)  # KxC, Kx2
