...
class uocfSingleTransModel(BaseModel):
	...
	def modify_commandline_options(parser, is_train=True):
		...
		parser.add_argument('--shape_dim', type=int, default=64, help='Dimension of individual z latent per slot')
		parser.add_argument('--color_dim', type=int, default=0, help='Dimension of individual z latent per slot texture')
