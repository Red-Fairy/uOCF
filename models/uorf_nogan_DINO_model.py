...
from .model import Encoder, Decoder, get_perceptual_net, raw2outputs
from .model_general import singleRouteEncoder, dualRouteEncoderSeparate


class uorfNoGanDINOModel(BaseModel):
