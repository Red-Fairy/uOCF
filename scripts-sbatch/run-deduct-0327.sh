...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 4  \
    ...
    --model 'uorf_nogan_T' \
    --exp_id '0327-deduct' --attn_iter 3 --percept_in 150 \
    --dummy_info 'new grid,  share grid embed projection, correct deduct operation (before azi transform), move deduction after locality, percept_in 150' \
