...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1200 --n_img_each_scene 4 \
    ...
    --model 'uorf_general' \
    --attn_decay_steps 100000 --freezeInit_ratio 1 --freezeInit_steps 24000  \
    --bottom \
    --encoder_size 896 --encoder_type 'DINO' \
    --num_slots 2 --attn_iter 4 --shape_dim 48 --color_dim 16 \
    --coarse_epoch 30 --niter 200 --percept_in 20 --no_locality_epoch 20 \
    ...
    --exp_id '0528-ProofOfConcepts/load-DINO-learn1obj-pos-freeze-r2' \
    --dummy_info 'load DINO, frozen decoder for 50000 steps' \
