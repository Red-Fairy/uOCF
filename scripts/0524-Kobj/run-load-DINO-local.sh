...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4 \
    ...
    --locality_in 10 --locality_full 10 --world_obj_scale 4.5 --obj_scale 3 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_diverse_mask/0522-TRAILS/attn-dualfeat-local-centered-DINO' \
    --exp_id '0524-TRAIL/load-DINO' \
