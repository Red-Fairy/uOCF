...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2  \
    ...
    --load_size 256 --n_samp 128 --input_size 128 --supervision_size 128 --frustum_size 128 \
    ...
    --bottom --fixed_locality --sam_encoder --encoder_size 1024 \
    --coarse_epoch 60 --niter 60 --percept_in 10 \
    --attn_decay_steps 100000 \
    --bg_color '-1' \
    --exp_id '0518-DEBUG/dataset-attn-1D2D-128sample' --mask_in 0 \
    --save_epoch_freq 2 \
    --dummy_info 'moving FG position, 1D2D representation, no project, fixed_locality, n_sample 128' \
