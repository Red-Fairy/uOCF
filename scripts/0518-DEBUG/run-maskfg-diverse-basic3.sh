...
python train_without_gan_debug.py --dataroot $DATAROOT --n_scenes 5 --n_img_each_scene 4  \
    --checkpoints_dir 'checkpoints' --name 'room_diverse_mask' \
    --display_port $PORT --display_ncols 4 --print_freq 5 --display_freq 5 \
    ...
    --coarse_epoch 10000 --niter 10000 --percept_in 500 --invariant_in 10000 --fg_in_world \
    --attn_decay_steps 100000 \
    --bg_color '-1' \
    --exp_id '0518-DEBUG/DEBUG-NeRF-slotattn-mask-1obj' --mask_in 0 --lr 0.0003 \
    --save_epoch_freq 500 \
    --dummy_info 'fixed FG position, 1shape singlesize, surface loss' \
