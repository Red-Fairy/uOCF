...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 200 --niter 400 --percept_in 50 --no_locality_epoch 0 --seed 2024 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/rebuttal/5slot/2-4chairs' \
    --load_epoch 'latest' \
    ...
    --exp_id '5slot-2-4/kitchen-hard-1' \
    --dummy_info '' \
