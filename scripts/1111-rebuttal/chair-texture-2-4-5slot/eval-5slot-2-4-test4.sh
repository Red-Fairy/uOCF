...
python test.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 72  --n_img_each_scene 4  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/rebuttal/5slot/2-4chairs' \
    --learnable_slot_init \
    --fixed_locality --fg_object_size 3 --vis_mask \
    --dummy_info 'regular test' --testset_name 'regula-4obj-test' \
