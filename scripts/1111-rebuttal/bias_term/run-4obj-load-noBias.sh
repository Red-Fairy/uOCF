...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_real_chairs/0824/1obj-scratch-IPE-r2' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --no_learnable_pos --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 10 --one2four \
    --continue_train --epoch_count 15 --n_dense_sample 224 \
    --exp_id 'bias_term/4obj-noBias' \
