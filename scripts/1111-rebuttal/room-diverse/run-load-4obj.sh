...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_diverse_bg/0827-IPE/1obj-scratch-pos-IPE' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 10 --one2four --n_dense_samp 256 \
    --exp_id 'room-diverse/4obj-load-2' \
    --dummy_info '' \
