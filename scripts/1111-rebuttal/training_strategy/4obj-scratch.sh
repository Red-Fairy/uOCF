...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 500 --niter 1000 --percept_in 200 --no_locality_epoch 100 --seed 2025 \
    --fixed_locality --continue_train --epoch 390 --epoch_count 391 \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --exp_id 'ablation-strategy/scratch' \
    --dummy_info '' \
