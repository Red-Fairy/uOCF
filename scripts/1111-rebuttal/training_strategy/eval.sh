...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 56 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/rebuttal/ablation-strategy/scratch' \
    --fixed_locality --recon_only --no_shuffle --fg_object_size 5 --show_recon_stats \
    --nss_scale 7 --epoch 1000 --vis_attn \
