...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 12 --niter 20 --percept_in 2 --no_locality_epoch 0 --seed 2025 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 10 --n_dense_samp 256 \
    --continue_train --epoch_count 12 \
    --exp_id 'chairs-original' \
