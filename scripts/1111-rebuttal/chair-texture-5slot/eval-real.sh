...
CUDA_VISIBLE_DEVICES=1 python test.py --dataroot $DATAROOT --n_scenes 56 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/kitchen-hard/0828/4obj-loadchairs-fine128-load30' \
    --fixed_locality --recon_only --no_shuffle --fg_object_size 3 \
    --nss_scale 7 --epoch 150 --vis_attn --vis_render_mask --no_loss \
