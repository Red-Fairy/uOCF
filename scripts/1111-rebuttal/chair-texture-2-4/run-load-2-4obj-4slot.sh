...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 15 --niter 30 --percept_in 5 --no_locality_epoch 0 --seed 2025 \
    ...
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 5 --n_dense_samp 256 --one2four \
    --learnable_slot_init \
    --exp_id '4slot-2-4obj/chairs' \
