...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 200 --niter 1000 --percept_in 100 --no_locality_epoch 0 --seed 2024 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/rebuttal/4slot-2-4obj/chairs' \
    --load_epoch 'latest' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --fixed_locality --dense_sample_epoch 200 --one2four \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --learnable_slot_init \
    --exp_id '4slot-2-4obj/kitchen-hard-3' \
    --dummy_info '' \
