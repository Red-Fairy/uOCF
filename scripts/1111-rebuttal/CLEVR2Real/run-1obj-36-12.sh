...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 3 \
    ...
    --num_slots 2 --attn_iter 4 --shape_dim 36 --color_dim 12 \
    --coarse_epoch 100 --niter 100 --percept_in 10 --no_locality_epoch 20 --seed 2027 \
    --position_loss --stratified --fixed_locality \
    --learnable_slot_init \
    --exp_id 'CLEVR2Real/1obj-36-12' \
