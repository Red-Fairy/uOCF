...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --coarse_epoch 40 --niter 80 --percept_in 20 --no_locality_epoch 30 --seed 2025 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 20 --n_feat_layer 4 \
    --learnable_slot_init \
    --exp_id 'encoder/4obj-stack4-learn' \
