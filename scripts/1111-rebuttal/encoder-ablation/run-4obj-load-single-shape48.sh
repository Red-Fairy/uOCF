...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --num_slots 5 --attn_iter 4 --shape_dim 48 --color_dim 0 \
    --coarse_epoch 40 --niter 80 --percept_in 10 --no_locality_epoch 0 --seed 2025 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/rebuttal/encoder/1obj-single-shape48' \
    ...
    --exp_id 'encoder/4obj-load-single-shape48' \
