...
python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4  \
    ...
    --vis_attn --vis_mask \
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/rebuttal/encoder/4obj-stack4-learn' \
    --fixed_locality --fg_object_size 3 --learnable_slot_init --n_feat_layer 4 \
