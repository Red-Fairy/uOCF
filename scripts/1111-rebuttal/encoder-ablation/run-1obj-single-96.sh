...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1296 --n_img_each_scene 2 \
    ...
    --num_slots 2 --attn_iter 4 --shape_dim 96 --color_dim 0 \
    --coarse_epoch 250 --niter 250 --percept_in 25 --no_locality_epoch 50 --seed 2029 \
    --learnable_slot_init --position_loss --fixed_locality --n_feat_layer 1 \
    --exp_id 'encoder/1obj-single-shape96-r2' \
