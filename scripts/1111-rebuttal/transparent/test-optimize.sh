...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/transparent'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --n_img_each_scene 2 \
    ...
    --coarse_epoch 0 --niter 20000 --percept_in 0 --no_locality_epoch 0 --seed 2025 --lr 0.0001 \
    ...
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 0 --n_dense_samp 192 \
    --exp_id 'transparent/alpha0.7' \
