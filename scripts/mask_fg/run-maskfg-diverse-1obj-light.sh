...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/room_diverse_nobg/train-1obj-manysize-trans'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4  \
    ...
    --exp_id '0504-maskfg-1obj-scale3.5-light' \
    --save_epoch_freq 10 \
    --dummy_info 'mask fg scale-3.5, light, fixed FG position, global attention' --is_train --bg_color '-1' \
