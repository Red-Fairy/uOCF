...
python train_without_gan_debug.py --dataroot $DATAROOT --n_scenes 5 --n_img_each_scene 4  \
    ...
    --coarse_epoch 10000 --niter 10000 --percept_in 500 --invariant_in 10000 \
    --attn_decay_steps 100000 \
    --bg_color '-1' \
    --exp_id '0518-DEBUG/DEBUG-NeRF-slotattn-lpips-5scenes' --mask_in 0 --lr 0.0003 \
    --save_epoch_freq 500 \
    --dummy_info 'slot attn, lpips, transform locality' \
