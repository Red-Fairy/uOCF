...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4  \
    ...
    --load_size 256 --n_samp 128 --input_size 128 --supervision_size 32 --render_size 32 \
    --model 'uorf_nogan_T_sam_fgmask' \
    --num_slots 1 --attn_iter 3 \
    --shape_dim 96 --color_dim 32 --world_obj_scale 3.5 --obj_scale 3.5 --locality_in 60 --locality_full 60 \
    --bottom --project \
    --sam_encoder --encoder_size 1024 \
    --coarse_epoch 0 --niter 60 --percept_in 5 \
    --attn_decay_steps 100000 \
    --bg_color '-1' \
    --exp_id '0518-SAM/mask-fg-debug-128' --mask_in 0 \
    --save_epoch_freq 2 \
