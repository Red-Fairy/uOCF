...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 200 --n_img_each_scene 4  \
    ...
    --shape_dim 48 --color_dim 16 --world_obj_scale 4.5 --obj_scale 3 --locality_in 50 --locality_full 200 \
    --bottom --project \
    --sam_encoder --encoder_size 1024 \
    --coarse_epoch 600 --niter 600 --percept_in 50 --surface_loss \
    --attn_decay_steps 100000 \
    --bg_color '-1' \
    --exp_id '0517-SAM/mask-fg-1obj-1shape' --mask_in 0 \
    --save_epoch_freq 2 \
