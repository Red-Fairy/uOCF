...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 60 --niter 120 --percept_in 10 --no_locality_epoch 20 --seed 2029 \
    ...
    --exp_id 'room-multiple/uOCF-load-2-4obj-noPlane' \
    --continue_train --epoch 5 --epoch_count 46 \
    --dummy_info '' \
