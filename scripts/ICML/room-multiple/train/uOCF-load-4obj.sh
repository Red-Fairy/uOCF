...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 40 --niter 40 --percept_in 5 --no_locality_epoch 20 --seed 2027 \
    ...
    --exp_id 'room-multiple/uOCF-load-2-4obj-rebuttal-40ep' \
    --continue_train --epoch 40 --epoch_count 31 \
    --dummy_info '' \
