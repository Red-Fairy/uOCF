...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 2 \
    ...
    --fg_density_loss --bg_density_loss --bg_density_in 1000 --collapse_prevent 10000 \
    --exp_id 'CLEVR/uOCF-1obj-2' \
    --dummy_info '' \
