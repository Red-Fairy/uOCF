...
DATAROOT=${1:-'/svl/u/redfairy/datasets/CLEVR/train-2-4obj'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 200 --niter 400 --percept_in 5 --no_locality_epoch 100 --seed 2027 \
