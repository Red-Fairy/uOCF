...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 102 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/kitchen-easy/4obj-load-noPlane-freeze' \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --vis_attn --vis_render_mask --recon_only --epoch 70 \
    --remove_duplicate \
    --scaled_depth --depth_scale_pred --depth_scale_param 2 \
    --dummy_info '' --testset_name 'test4obj_load128_102scenes' \
