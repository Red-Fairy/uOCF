...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 120 --start_scene_idx 610 --n_img_each_scene 2 \
    ...
    --coarse_epoch 250 --niter 1000 --percept_in 30 --no_locality_epoch 60 --seed 2024 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 60 --n_feat_layers 1 \
    ...
    --vis_mask \
    --exp_id 'kitchen-easy/4obj-load-from750' \
    --continue_train --epoch 800 --epoch_count 801 \
