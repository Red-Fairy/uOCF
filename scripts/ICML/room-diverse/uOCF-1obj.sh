...
DATAROOT=${1:-'/svl/u/redfairy/datasets/room_diverse/train-1obj'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 2000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 100 --niter 100 --percept_in 10 --no_locality_epoch 20 --seed 2024 \
    ...
    --exp_id 'room-diverse/uOCF-1obj' \
    --continue_train --epoch 5 --epoch_count 6 \
    --dummy_info '' \
