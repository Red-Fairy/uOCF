...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 7524 --n_img_each_scene 2 \
    ...
    --coarse_epoch 60 --niter 60 --percept_in 8 --no_locality_epoch 10 --seed 2024 \
    --stratified --fixed_locality --fg_object_size 3 --n_feat_layers 1 \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --no_mask \
    --exp_id 'room-multiple-objverse/uOCF-1obj-v2' \
