...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/room-multiple-objverse/uOCF-4obj-v2' \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --vis_attn --vis_mask --remove_duplicate --epoch 40 \
