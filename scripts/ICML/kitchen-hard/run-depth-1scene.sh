...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 20 --n_img_each_scene 1 --no_shuffle \
    ...
    --coarse_epoch 10000 --niter 10000 --percept_in 1000 --no_locality_epoch 2000 --seed 2024 \
    ...
    --vis_mask \
    --exp_id 'kitchen-hard/4obj-kiteasy2hard' \
