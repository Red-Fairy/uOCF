...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --num_slots 7 --attn_iter 6 --shape_dim 48 --color_dim 48 \
    --coarse_epoch 250 --niter 1500 --percept_in 75 --no_locality_epoch 150 --seed 2024 \
    ...
    --bg_density_loss --depth_supervision --n_dense_samp 224 \
    --vis_mask \
    --continue_train --epoch 480 --epoch_count 481 \
    --exp_id 'kitchen-hard/4obj-load-1obj-6slot' \
