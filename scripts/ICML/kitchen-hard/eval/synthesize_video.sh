...
CUDA_VISIBLE_DEVICES=0 python test-video.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 22 --n_img_each_scene 2 \
    ...
    --dummy_info 'test_real' --testset_name 'test_video_256_scene22' \
