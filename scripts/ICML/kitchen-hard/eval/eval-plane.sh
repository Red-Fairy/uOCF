...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 22 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/kitchen-hard/4obj-load-noPlane-final' \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --scaled_depth --depth_scale_pred --depth_scale_param 2 \
    --vis_attn --vis_render_mask --recon_only --epoch 120 \
