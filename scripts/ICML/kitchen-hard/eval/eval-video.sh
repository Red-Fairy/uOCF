...
CUDA_VISIBLE_DEVICES=0 python test-slot-video.py --dataroot $DATAROOT --n_scenes 54 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --epoch 1000 \
    --wanted_indices '4' --video_mode 'spherical' --move2center \
    --testset_name 'white' --white_bkgd \
