...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 350 --niter 800 --percept_in 75 --no_locality_epoch 150 --seed 2024 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 150 --n_feat_layers 1 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/CLEVR/uOCF-load-2-4obj' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --bg_density_loss --depth_supervision \
    --continue_train --epoch 220 --epoch_count 221 \
    --vis_mask \
    --exp_id 'kitchen-hard/4obj-load-CLEVR' \
