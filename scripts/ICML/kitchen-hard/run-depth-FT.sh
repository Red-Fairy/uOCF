...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 72 --n_img_each_scene 2 \
    ...
    --coarse_epoch 250 --niter 1800 --percept_in 75 --no_locality_epoch 150 --seed 2024 \
    ...
    --exp_id 'kitchen-hard/4obj-load-FT' \
