...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --n_img_each_scene 1 --no_shuffle \
    ...
    --coarse_epoch 1000 --niter 1000 --percept_in 0 --no_locality_epoch 0 --seed 2024 \
    ...
    --bg_density_loss --depth_supervision --n_dense_samp 192 \
    --near 1.97 --far 6.56 --nss_scale 2.30 \
    --remove_duplicate \
    --vis_mask \
    --continue_train --epoch 500 --epoch_count 501 \
    --exp_id 'room-texture/4obj-hm3d' \
