...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --num_slots 11 --attn_iter 6 --shape_dim 48 --color_dim 48 \
    --coarse_epoch 120 --niter 120 --percept_in 5 --no_locality_epoch 20 --seed 2027 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 20 --n_feat_layers 1 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/room-texture/uOCF-1obj' \
    ...
    --exp_id 'room-texture/uOCF-load-10obj' \
    --continue_train --epoch_count 60 \
    --dummy_info '' \
