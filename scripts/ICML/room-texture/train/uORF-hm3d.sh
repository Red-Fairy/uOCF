...
CUDA_VISIBLE_DEVICES=1 python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --n_img_each_scene 1 --no_shuffle  \
    ...
    --coarse_epoch 1000 --niter 1000 --no_locality_epoch 0 --z_dim 96 --num_slots 5 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/room-multiple/uORF-4obj' \
