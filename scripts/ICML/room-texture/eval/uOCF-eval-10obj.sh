...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4  \
    ...
    --load_size 128 --n_samp 256 --input_size 128 --render_size 8 --frustum_size 128 \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/room-texture/uOCF-load-10obj' \
