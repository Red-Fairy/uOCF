...
python test-slot-video.py --dataroot $DATAROOT --n_scenes 1 --n_img_each_scene 1  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/room-texture/4obj-zeroshot-real' \
    --recon_only --vis_render_mask --vis_attn --epoch 5000 --no_loss \
    --remove_duplicate --video_mode 'spherical' \
    --dummy_info 'regular test' --testset_name 'real-video' \
