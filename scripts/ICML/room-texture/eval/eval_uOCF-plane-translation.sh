...
DATAROOT=${1:-'/svl/u/redfairy/datasets/room-real/chairs/test-4obj-move'}
PORT=${2:-12783}
...
CUDA_VISIBLE_DEVICES=1 python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4 \
    ...
    --manipulate_mode 'translation' --epoch 120  \
    --pos_emb --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/ICML/room-texture/uOCF-load-2-4obj-noPlane' \
    --testset_name 'manip_translation'  \
