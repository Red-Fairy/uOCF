...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 3000 --n_img_each_scene 2 \
    ...
    --attn_decay_steps 200000 --bottom --lr 0.0003 \
    --encoder_size 896 --encoder_type 'DINO' \
    --num_slots 8 --attn_iter 6 --shape_dim 48 --color_dim 48 --n_feat_layers 1  \
    --coarse_epoch 200 --niter 400 --percept_in 30 --no_locality_epoch 100 --seed 2025 \
    --stratified --fixed_locality --dense_sample_epoch 100 \
    --near 2.0 --far 10.0 --nss_scale 2.5 --fg_object_size 0.75 --obj_scale 2.5 \
    ...
    --remove_duplicate --remove_duplicate_in 20 \
    --continue_train --epoch 80 --epoch_count 81 \
    --multiview_loss --multiview_in 82 \
    --exp_id '1225-modNorm/load-depth-single-multiview' \
