...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 3000 --n_img_each_scene 3 \
    ...
    --display_port $PORT --display_ncols 4 --print_freq 10 --display_freq 10 --save_epoch_freq 5 \
    ...
    --pseudo_mask_loss --pseudo_mask_in 50 --weight_pseudo_mask 2000 \
    --exp_id '1212-modNorm/load-pseudoMask' \
