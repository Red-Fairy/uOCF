...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 3000 --n_img_each_scene 2 \
    ...
    --attn_decay_steps 100000 --bottom --lr 0.0002 \
    ...
    --exp_id '1202-overseg-predScale/load-removeDup' \
    --continue_train --epoch 95 --epoch_count 96 \
    --pseudo_mask_loss --pseudo_mask_in 50 --pseudo_mask_loss_type 'cosine' \
    --dummy_info '' \
