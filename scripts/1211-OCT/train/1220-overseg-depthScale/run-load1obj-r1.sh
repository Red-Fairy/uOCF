...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 3000 --n_img_each_scene 3 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1220-predDepthScale/1obj-r1' \
    ...
    --pseudo_mask_loss --pseudo_mask_in 30 --vis_mask \
    --remove_duplicate --remove_duplicate_in 10 \
    --exp_id '1202-overseg-predScale/load1obj-removeDup' \
