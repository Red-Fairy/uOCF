...
CUDA_VISIBLE_DEVICES=1 python test.py --dataroot $DATAROOT --n_scenes 100 --start_scene_idx 3100 --n_img_each_scene 4  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/OCTScenes/1225-modNorm/load-depth' \
    --fixed_locality \
    --remove_duplicate \
