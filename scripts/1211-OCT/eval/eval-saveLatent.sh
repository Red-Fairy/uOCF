...
CUDA_VISIBLE_DEVICES=0 python test-saveLatent.py --dataroot $DATAROOT --n_scenes 100 --start_scene_idx 3100 --n_img_each_scene 4  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/OCTScenes/1212-modNorm/load-default-noMask' \
    --fixed_locality \
    ...
    --dummy_info 'test_real' --testset_name 'regular_saveLatent' \
