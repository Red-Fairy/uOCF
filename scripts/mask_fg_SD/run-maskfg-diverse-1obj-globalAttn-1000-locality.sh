...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4  \
    ...
    --transparent  --mask_in 0 --bg_color -1 --surface_loss --world_obj_scale 4.5 --obj_scale 3 \
    --exp_id '0517-SD/maskfg-1obj' \
    --dummy_info 'mask fg scale-4, light, fixed FG position, global attention' \
