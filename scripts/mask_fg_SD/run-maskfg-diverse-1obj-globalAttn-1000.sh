...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 4  \
    ...
    --load_size 128 --n_samp 96 --input_size 128 --supervision_size 96 --frustum_size 96 \
    --model 'uorf_nogan_T_SD_fgmask' --dataset_mode 'multiscenesSD' \
    --num_slots 1 --attn_iter 3 --z_dim 64 --encoder_size 256 \
    --project \
    --coarse_epoch 0 --niter 600 --percept_in 50 \
    --attn_decay_steps 100000 --save_epoch_freq 10 \
    --transparent  --mask_in 0 --bg_color -1 \
    --exp_id '0513-SD/maskfg-1obj-globalattn-each-movingFG-debug' \
    --dummy_info 'mask fg scale-3.5, light, moving FG position, global attention' \
