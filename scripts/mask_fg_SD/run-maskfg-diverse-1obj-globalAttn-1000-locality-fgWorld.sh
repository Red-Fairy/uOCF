...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 4  \
    ...
    --attn_decay_steps 100000 --save_epoch_freq 10 --fg_in_world \
    --transparent  --mask_in 0 --bg_color -1 --surface_loss --world_obj_scale 4.5 --obj_scale 3 --locality_in 10 --locality_full 40 \
    --exp_id '0517-SD/train-1obj-decayLocality-fgWorld' \
    --dummy_info 'mask fg scale-4, light, fixed FG position, global attention, fg in world' \
