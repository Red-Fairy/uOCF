...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 200 --n_img_each_scene 4  \
    ...
    --transparent  --mask_in 0 --bg_color -1 --surface_loss --obj_scale 5 \
    --exp_id '0516-SD/maskfg-1obj-1shape-obj5' \
    --dummy_info 'mask fg scale=5, moving FG position, global attention, locality out' \
