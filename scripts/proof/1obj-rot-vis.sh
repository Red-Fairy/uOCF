...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/room-real/chairs/test-1obj-proof-rot'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python test-interpolate.py --dataroot $DATAROOT --n_scenes 1 --n_img_each_scene 1  \
    ...
    --dummy_info 'regular test' --testset_name 'proof-rot' --epoch 300 \
