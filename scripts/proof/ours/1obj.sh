...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/room-real/chairs/test-1obj-proof'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python test.py --dataroot $DATAROOT --n_scenes 12 --n_img_each_scene 1  \
    ...
    --recon_only --no_loss \
    --dummy_info 'regular test' --testset_name 'standard' --epoch 300 \
