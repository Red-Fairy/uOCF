...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4 \
    ...
    --coarse_epoch 80 --niter 160 --percept_in 10 --no_locality_epoch 10 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_diverse_bg/1obj-scratch' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --exp_id '0531-Kobj/load-DINO-4obj-ttf-1objScratch' \
    --dummy_info 'load DINO (directly 1 obj bg), frozen decoder for 100000 steps' \
