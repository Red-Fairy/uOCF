...
DATAROOT=${1:-'/viscam/projects/uorf-extension/scene_generation/datasets/3600shape_nobg-large'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3  \
    --checkpoints_dir 'checkpoints' --name 'room_multiple3obj' \
    ...
    --exp_id '0415-sam-texture-nobg' --attn_iter 4 \
