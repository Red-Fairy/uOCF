...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 730 --n_img_each_scene 2 \
    ...
    --display_port $PORT --display_ncols 4 --print_freq 73 --display_freq 73 --save_epoch_freq 20 \
    --load_size 128 --n_samp 64 --input_size 128 --supervision_size 64 --frustum_size 64 \
    --model 'uorf_general' \
    --bottom --attn_decay_steps 20000 \
    --encoder_size 896 --encoder_type 'DINO' \
    --num_slots 6 --attn_iter 4 --shape_dim 48 --color_dim 48 --near 6 --far 20 \
    --coarse_epoch 250 --niter 1000 --percept_in 200 --no_locality_epoch 0 --seed 2025 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-easy/4obj-load4obj-333' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --fixed_locality --color_in_attn \
    --exp_id 'dataset-0817/4obj-load4obj333-ttt-700-0817' \
    --dummy_info 'DINO load from 4 obj 333' \
