...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 760 --n_img_each_scene 2 \
    ...
    --bg_density_loss --frequency_mask \
    --exp_id 'dataset-0817-0828/4obj-loadchairs-objtop-bg-free-fine128-load24' \
    --dummy_info 'DINO load from 4 obj chairs synthetic, 15 epoch' \
