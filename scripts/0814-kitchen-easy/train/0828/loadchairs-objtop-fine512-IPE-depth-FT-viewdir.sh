...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 120 --start_scene_idx 610 --n_img_each_scene 2 \
    ...
    --display_port $PORT --display_ncols 4 --print_freq 30 --display_freq 30 --save_epoch_freq 10 \
    --load_size 512 --n_samp 64 --input_size 128 --frustum_size_fine 512 \
    ...
    --continue_train --epoch 1500 --epoch_count 1501 --use_viewdirs \
    --exp_id 'dataset-0817-0828/4obj-loadchairs-depth-512-FT-viewdir' \
