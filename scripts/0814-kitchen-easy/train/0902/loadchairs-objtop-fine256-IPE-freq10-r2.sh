...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 760 --n_img_each_scene 2 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_chairs/0824/4obj-load-IPE-freq10-nodense' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --fixed_locality --dense_sample_epoch 100 --load_epoch 80 \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --bg_density_loss \
    --n_freq 10 \
    --exp_id 'dataset-0817-freq10/4obj-loadchairs-fine256-load80' \
