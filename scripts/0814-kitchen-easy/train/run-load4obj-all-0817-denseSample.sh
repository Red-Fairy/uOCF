...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 730 --n_img_each_scene 2 \
    ...
    --display_port $PORT --display_ncols 4 --print_freq 10 --display_freq 10 --save_epoch_freq 20 \
    --load_size 128 --n_samp 64 --input_size 128 --supervision_size 64 --frustum_size 4 \
    --model 'uorf_general' \
    ...
    --continue_train --epoch 100 --epoch_count 101 --dense_sample_epoch 100 \
    --exp_id 'dataset-0817/4obj-load4obj-ttt-denseSample' \
