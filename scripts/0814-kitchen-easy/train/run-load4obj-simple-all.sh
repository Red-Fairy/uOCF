...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/kitchen-easy/4obj-all-simple-train'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 498 --n_img_each_scene 2 \
    --checkpoints_dir 'checkpoints' --name 'kitchen-easy' \
    --display_port $PORT --display_ncols 4 --print_freq 166 --display_freq 166 --save_epoch_freq 20 \
    ...
    --exp_id '4obj-load4obj-ttt-simple-498' \
