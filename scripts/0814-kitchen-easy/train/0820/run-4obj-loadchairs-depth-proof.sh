...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 715 --n_img_each_scene 2 \
    --checkpoints_dir 'checkpoints' --name 'kitchen-easy' \
    --display_port $PORT --display_ncols 4 --print_freq 1 --display_freq 1 --save_epoch_freq 500 \
    ...
    --coarse_epoch 250 --niter 10000 --percept_in 100 --no_locality_epoch 0 --seed 2025 \
    ...
    --continue_train --epoch 900 --epoch_count 901 \
    --depth_supervision \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --exp_id 'dataset-0817-new/4obj-loadchairs-fine128-depth-proof-2' \
