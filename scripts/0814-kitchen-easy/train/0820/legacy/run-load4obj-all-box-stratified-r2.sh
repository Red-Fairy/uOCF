...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 730 --n_img_each_scene 2 \
    ...
    --fixed_locality --color_in_attn --stratified --dense_sample_epoch 100 --n_dense_samp 128 \
    --continue_train --epoch 120 --epoch_count 121 \
    --exp_id 'dataset-0817-new/4obj-load4obj-box-stratified-removeNegativeZ' \
