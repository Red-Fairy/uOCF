...
CUDA_VISIBLE_DEVICES=1 python test.py --dataroot $DATAROOT --n_scenes 30 --start_scene_idx 730 --n_img_each_scene 2  \
    ...
    --nss_scale 7 \
    --dummy_info 'test_real' --testset_name 'test4obj_cabinet_360_trainset' \
