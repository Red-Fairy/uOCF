...
PORT=${2:-12783}
CUDA_VISIBLE_DEVICES=1 python test-slot-video.py --dataroot $DATAROOT --n_scenes 95 --n_img_each_scene 1 \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-easy/4obj-load4obj-ttt-700-0816-fastDecay' \
