...
CUDA_VISIBLE_DEVICES=1 python test.py --dataroot $DATAROOT --n_scenes 10 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/kitchen-easy/dataset-0817-0828/4obj-loadchairs-inPaperResults' \
    --fixed_locality --recon_only --no_shuffle --fg_object_size 3 --show_recon_stats \
    --nss_scale 7 --vis_render_mask --epoch 1250 \
    --dummy_info 'test_real' --testset_name 'test_3obj' \
