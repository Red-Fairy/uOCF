...
CUDA_VISIBLE_DEVICES=1 python test-video-manipulate.py --dataroot $DATAROOT --n_scenes 100 --start_scene_idx 0 --n_img_each_scene 1  \
    ...
    --wanted_indices '97' --epoch 2000 --use_viewdirs \
    --dummy_info 'test_real' --testset_name 'test_video_trans_256' \
