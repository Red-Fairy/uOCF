...
CUDA_VISIBLE_DEVICES=1 python test.py --dataroot $DATAROOT --n_scenes 35 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-easy/dataset-0817-0828/4obj-loadchairs-fine256-load80-depth' \
    --fixed_locality --recon_only --no_shuffle --fg_object_size 3 --show_recon_stats \
    --nss_scale 7 --vis_disparity \
    --dummy_info 'test_real' --testset_name 'train4obj_cabinet0910_load128' \
