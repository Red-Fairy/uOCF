...
PORT=${2:-12783}
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 70 --start_scene_idx 30 --n_img_each_scene 2 \
    ...
    --recon_only \
    --attn_iter 3 --testset_name 'regular_test_cabinet_1500'  \
# done
echo "Done"