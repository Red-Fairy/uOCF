...
PORT=${2:-12783}
CUDA_VISIBLE_DEVICES=1 python test.py --dataroot $DATAROOT --n_scenes 30 --start_scene_idx 0 --n_img_each_scene 2 \
    ...
    --pos_emb --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-easy/uORF-4obj' \
    --recon_only \
    --attn_iter 3 --testset_name 'regular_test_tabletop_1500'  \
# done
echo "Done"