...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 77 --start_scene_idx 30 --n_img_each_scene 2  \
    ...
    --vis_disparity \
    --dummy_info 'test_real' --testset_name 'test4obj_cabinet_load128_disparity' \
