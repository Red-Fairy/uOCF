...
CUDA_VISIBLE_DEVICES=0 python test-manipulation.py --dataroot $DATAROOT --n_scenes 100 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-easy/dataset-0817-new/4obj-loadchairs-objtop-fine256' \
    --fixed_locality --recon_only --no_shuffle --fg_object_size 3 --show_recon_stats \
    --nss_scale 7 --epoch 1000 --wanted_indices '97' \
    --dummy_info 'test_real' --testset_name 'test4obj_cabinet_load256_vis' \
