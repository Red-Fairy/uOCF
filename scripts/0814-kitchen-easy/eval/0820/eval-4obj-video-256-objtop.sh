...
PORT=${2:-12783}
CUDA_VISIBLE_DEVICES=1 python test-video.py --dataroot $DATAROOT \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-easy/dataset-0817-new/4obj-loadchairs-objtop-fine256-bgdensity' \
