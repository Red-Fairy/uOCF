...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/room-real/plant_pot/train-white-4obj'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_pots/1obj-scratch-fixed' \
    --fixed_locality \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --exp_id '4obj-load-ttf-fixed' \
