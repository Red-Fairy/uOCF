...
DATAROOT=${1:-'/svl/u/redfairy/datasets/room-real/plant_pots/train-white-1obj-nofoot-viewrange-medium-4550'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 970 --n_img_each_scene 3 \
    ...
    --coarse_epoch 300 --niter 300 --percept_in 25 --no_locality_epoch 50 --seed 2029 \
    --exp_id '0724/1obj-scratch-pos-r2' \
    --position_loss --position_in 75 \
    --obj_scale 4.5 --world_obj_scale 4.5 \
    --fixed_locality \
    --dummy_info 'DINO from scratch 1 obj with BG, position loss in the nss space' \
