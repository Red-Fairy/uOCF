...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 970 --n_img_each_scene 2 \
    ...
    --coarse_epoch 400 --niter 400 --percept_in 25 --no_locality_epoch 50 --seed 2023 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_pots/0724-new/1obj-mask-7224' \
    ...
    --color_in_attn \
    --exp_id '0724-new/1obj-load-uuf-pos-7224' \
