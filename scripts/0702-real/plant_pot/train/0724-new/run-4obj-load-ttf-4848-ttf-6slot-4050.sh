...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --fixed_locality --color_in_attn --load_epoch 280 \
    --exp_id '0724-new/4obj-load-ttf-4848-6slot-4050' \
    --dummy_info 'DINO load from 1 obj scratch, 280 epoch' \
