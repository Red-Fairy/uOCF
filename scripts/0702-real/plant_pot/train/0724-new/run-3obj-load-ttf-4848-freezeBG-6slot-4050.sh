...
DATAROOT=${1:-'/svl/u/redfairy/datasets/room-real/plant_pots/train-white-3obj-nofoot-viewrange-large-4050'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --coarse_epoch 50 --niter 100 --percept_in 20 --no_locality_epoch 0 --seed 2025 \
    ...
    --exp_id '0724-new/3obj-load-freezeBG-6slot-4050' \
    --dummy_info 'DINO load from 1 obj scratch, 200 epoch' \
