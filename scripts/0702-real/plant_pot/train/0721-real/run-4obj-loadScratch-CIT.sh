...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 210 --n_img_each_scene 3 \
    ...
    --coarse_epoch 100 --niter 2000 --percept_in 250 --no_locality_epoch 0 --seed 2025 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_pots/0721-real/1obj-loadScratch-ttt-CIT' \
    ...
    --exp_id '0721-real/4obj-loadScratch-CIT-freezeBG-noloc-6slot' \
    --dummy_info 'DINO load from 1 obj real, 2500 epoch' \
