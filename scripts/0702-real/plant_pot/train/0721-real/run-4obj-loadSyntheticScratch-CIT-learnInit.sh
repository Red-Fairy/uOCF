...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 210 --n_img_each_scene 3 \
    ...
    --display_port $PORT --display_ncols 4 --print_freq 70 --display_freq 70 --save_epoch_freq 30 \
    ...
    --fixed_locality --load_intrinsics --color_in_attn --freeze_bg_only --learnable_slot_init --load_epoch 280 \
    --exp_id '0721-real/4obj-loadSyntheticScratch-CIT-freezeBG-noloc-learninit-6slot' \
