...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 970 --n_img_each_scene 3 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_pots/0724-SD/1obj-mask-7224' \
    ...
    --exp_id '0724-SD/1obj-load-uuf-pos-7224' \
    --obj_scale 4.5 --world_obj_scale 4.5 \
    --fixed_locality \
    --dummy_info 'SD load uuf 1 obj with BG, position loss in the nss space, weight position = 0.1' \
