...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/dataset-0731/1obj/dataset_undistorted_multiview'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 33 --n_img_each_scene 2 \
    --checkpoints_dir 'checkpoints' --name 'room_real_pots' \
    --display_port $PORT --display_ncols 4 --print_freq 33 --display_freq 33 --save_epoch_freq 30 \
    ...
    --coarse_epoch 2000 --niter 2000 --percept_in 500 --no_locality_epoch 0 --seed 2023 \
    ...
    --exp_id '0731-real/1obj-load-freezeBG' \
