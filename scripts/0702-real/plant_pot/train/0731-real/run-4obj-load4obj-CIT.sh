...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/dataset-0801/4obj-all_multiview'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 320 --n_img_each_scene 3 \
    ...
    --exp_id '0731-real/4obj-load4obj-CIT-pot-vase' \
    --dummy_info 'DINO load from 4 obj synthetic, 104 epoch' \
