...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/4obj-cupbowl-bg_multiview'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 46 --n_img_each_scene 2 \
    ...
    --fixed_locality \
    --exp_id '0801-real/4obj-load4objChairs-CIT-ttt-cupbowl-46' \
