...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 360 --n_img_each_scene 3 \
    ...
    --exp_id '0801-real/4obj-load4obj-CIT-ttt-potvase-whiteBG' \
