...
DATAROOT=${1:-'/svl/u/redfairy/datasets/room-real/plant_pots/train-white-4obj-nofoot-viewrange-large-4555'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --num_slots 5 --attn_iter 4 --shape_dim 96 --color_dim 32 --near_plane 5 --far_plane 20 \
    --freezeInit_steps 100000 \
    --world_obj_scale 4.5 --obj_scale 4.5 \
    --coarse_epoch 80 --niter 160 --percept_in 20 --no_locality_epoch 50 --seed 2024 \
    ...
    --fixed_locality \
    --exp_id '4obj-load-ttf-nofoot-fixed-large-range4055-2' \
    --dummy_info 'DINO load from 1 obj with BG, epoch ~290' \
