...
DATAROOT=${1:-'/svl/u/redfairy/datasets/room-real/plant_pots/train-white-4obj-nofoot-viewrange-large-4050-close'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --freezeInit_steps 150000 \
    --coarse_epoch 80 --niter 160 --percept_in 30 --no_locality_epoch 50 --seed 2031 \
    ...
    --fixed_locality \
    --sfs_loss --weight_sfs 0.05 \
    --exp_id '4obj-load-ttf-nofoot-fixed-large-range4050-freeze30-sfs' \
