...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/real/dataset-4obj-0718/dataset_undistorted_processed'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 202 --n_img_each_scene 3 \
    ...
    --coarse_epoch 2000 --niter 4000 --percept_in 500 --no_locality_epoch 1000 --seed 2027 \
    ...
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' --freeze_bg_only \
    --fixed_locality \
    --exp_id '4obj-load-ttf-real' \
