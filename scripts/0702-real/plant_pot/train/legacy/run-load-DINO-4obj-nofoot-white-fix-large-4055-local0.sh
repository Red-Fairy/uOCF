...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --coarse_epoch 80 --niter 160 --percept_in 20 --no_locality_epoch 50 --seed 2027 \
    ...
    --fixed_locality --locality_in 0 \
    --exp_id '4obj-load-range4055-local0' \
    --dummy_info 'DINO load from 1 obj with BG, epoch 300 end' \
