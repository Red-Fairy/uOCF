...
# process starts
DATAROOT=${1:-'/svl/u/redfairy/datasets/room-real/plant_pots/train-white-1obj-nofoot-viewrange'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 970 --n_img_each_scene 3 \
    ...
    --exp_id '1obj-scratch-nofoot-fixed-viewrange' \
    --continue_train --epoch 25 --epoch_count 26 \
