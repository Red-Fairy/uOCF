...
CUDA_VISIBLE_DEVICES=0 python test-slot-video.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 1  \
    ...
    --fixed_locality --color_in_attn --recon_only --color_in_attn --no_shuffle \
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_pots/0724-new/4obj-load-freezeBG-4848-6slot-4050' \
    --video_mode 'spherical' --video \
    --dummy_info 'regular test' --testset_name 'video_slot' --epoch 160 \
