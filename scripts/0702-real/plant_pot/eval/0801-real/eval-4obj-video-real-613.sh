#!/bin/bash
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/4obj-kitchen-cupbowlplate-compose-test_multiview'}
PORT=${2:-12783}
CUDA_VISIBLE_DEVICES=1 python test-video.py --dataroot $DATAROOT --n_scenes 15 --n_img_each_scene 1 \
    ...
    --attn_iter 4 --no_loss --recon_only --video --testset_name test_video --epoch 260 \
# done
echo "Done"