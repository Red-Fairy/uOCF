...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/4obj-kitchen-test_multiview'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python test.py --dataroot $DATAROOT --n_scenes 10 --n_img_each_scene 2  \
    ...
    --fixed_locality --recon_only --color_in_attn --no_shuffle --epoch 760 \
    --nss_scale 7 \
    --dummy_info 'test_real' --testset_name '660ep_test4obj-kitchen' \
