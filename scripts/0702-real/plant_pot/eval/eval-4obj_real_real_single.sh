...
python test.py --dataroot $DATAROOT --n_scenes 25 --n_img_each_scene 3  \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_pots/0721-real/4obj-load4obj-CIT-freezeBG-noloc-6slot-singleView' \
    --fixed_locality --recon_only --load_intrinsics --color_in_attn --no_shuffle \
    --nss_scale 7 \
    --dummy_info 'test_real' --testset_name 'test-400ep-singleRecon' \
