...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_chairs/0824/1obj-scratch-pos-fixed' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 20 --one2four --n_dense_samp 192 \
    --exp_id '0824/4obj-load-r3' \
    --dummy_info 'DINO from scratch 1 obj with BG and position loss (250 epoch), dense sampling at 20' \
