...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --n_img_each_scene 4 \
    ...
    --coarse_epoch 5000 --niter 20000 --percept_in 0 --no_locality_epoch 0 --seed 2025 \
    ...
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 0 --n_dense_samp 256 \
    --exp_id '0824/4obj-load-IPE-zeroShot' \
    --nss_scale 2.905 \
