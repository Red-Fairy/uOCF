...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_real_chairs/0906-viewdir/1obj-scratch-IPE-r1' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --stratified --fixed_locality --one2four \
    --exp_id '0906-viewdir/4obj-load-IPE-nodense-r7-dummy' --use_viewdirs --dummy_viewdirs \
