...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 54 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-hard/1024/4obj-loadchairs-single' \
    --fixed_locality --recon_only --vis_render_mask --no_shuffle --fg_object_size 3 --show_recon_stats \
    --nss_scale 7 --epoch 420 \
