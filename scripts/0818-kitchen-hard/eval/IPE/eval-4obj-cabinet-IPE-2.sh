...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 20 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-hard/0828/4obj-loadchairs-fine256-1scenes-zeroshot-20-1view' \
    --fixed_locality --recon_only --vis_render_mask --no_shuffle --fg_object_size 3 --show_recon_stats \
    --nss_scale 7 --epoch 500 \
