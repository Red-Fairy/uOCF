...
CUDA_VISIBLE_DEVICES=0 python test-video-manipulate.py --dataroot $DATAROOT --n_scenes 56 --start_scene_idx 0 --n_img_each_scene 1  \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-hard/0828/4obj-loadchairs-fine256-depth' \
    --fixed_locality --recon_only --no_shuffle --fg_object_size 3 \
    --nss_scale 7 --video_mode 'spiral' --no_loss \
    --wanted_indices '5' --epoch 1500 \
