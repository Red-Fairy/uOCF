...
CUDA_VISIBLE_DEVICES=0 python test-video-manipulate.py --dataroot $DATAROOT --n_scenes 12 --start_scene_idx 0 --n_img_each_scene 1  \
    ...
    --nss_scale 7 --epoch 1500 --no_loss --video_mode 'spiral' \
    --wanted_indices '5' \
