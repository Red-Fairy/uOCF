...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/kitchen-hard-new/4obj-cabinet-train-10'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 10 --n_img_each_scene 2 \
    ...
    --coarse_epoch 5000 --niter 20000 --percept_in 1000 --no_locality_epoch 0 --seed 2025 \
    ...
    --fixed_locality --dense_sample_epoch 2000 --depth_supervision --depth_in 10000 \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --bg_density_loss \
    --exp_id '0828/4obj-loadchairs-fine256-10scenes' \
