...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 10 --n_img_each_scene 2 \
    ...
    --attn_decay_steps 10000 \
    --bottom \
    --encoder_size 896 --encoder_type 'DINO' \
    --num_slots 5 --attn_iter 4 --shape_dim 72 --color_dim 24 --near 6 --far 20 \
    --coarse_epoch 2500 --niter 10000 --percept_in 1000 --no_locality_epoch 0 --seed 2025 \
    ...
    --fixed_locality --dense_sample_epoch 1500 --depth_supervision --depth_in 5000 \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --bg_density_loss \
    --exp_id '0828/4obj-loadchairs-fine256-10scenes-largeFOV' \
