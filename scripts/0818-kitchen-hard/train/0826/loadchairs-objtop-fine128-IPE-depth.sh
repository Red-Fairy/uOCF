...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 250 --niter 1500 --percept_in 100 --no_locality_epoch 0 --seed 2025 \
    ...
    --bg_density_loss --depth_supervision --weight_depth_ranking 1.5 \
    --continue_train --epoch 1000 --epoch_count 1001 \
    --exp_id '0828/4obj-loadchairs-bg-depth' \
