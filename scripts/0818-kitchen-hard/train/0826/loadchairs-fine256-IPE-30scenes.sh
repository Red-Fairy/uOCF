...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/kitchen-hard-new/4obj-train-30'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 30 --n_img_each_scene 2 \
    --checkpoints_dir 'checkpoints' --name 'kitchen-hard' \
    --display_port $PORT --display_ncols 4 --print_freq 30 --display_freq 30 --save_epoch_freq 100 \
    ...
    --coarse_epoch 1500 --niter 5000 --percept_in 300 --no_locality_epoch 0 --seed 2025 \
    ...
    --fixed_locality --dense_sample_epoch 1000 --depth_supervision --depth_in 2500 \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --bg_density_loss \
    --exp_id '0828/4obj-loadchairs-fine256-30scenes-2' \
