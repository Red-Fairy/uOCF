...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/kitchen-hard-new/4obj-train-70'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 70 --n_img_each_scene 2 \
    --checkpoints_dir 'checkpoints' --name 'kitchen-hard' \
    --display_port $PORT --display_ncols 4 --print_freq 70 --display_freq 70 --save_epoch_freq 100 \
    ...
    --coarse_epoch 750 --niter 3000 --percept_in 150 --no_locality_epoch 0 --seed 2025 \
    ...
    --bg_density_loss \
    --exp_id '0828/4obj-loadchairs-fine256-70scenes' \
