...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 144 --n_img_each_scene 2 \
    --checkpoints_dir 'checkpoints' --name 'kitchen-hard' \
    --display_port $PORT --display_ncols 4 --print_freq 72 --display_freq 72 --save_epoch_freq 100 \
    ...
    --coarse_epoch 500 --niter 2000 --percept_in 200 --no_locality_epoch 0 --seed 2025 \
    ...
    --fixed_locality --dense_sample_epoch 200 --depth_supervision --depth_in 15000 \
    --stratified --fg_object_size 3 --n_dense_samp 256 \
    --bg_density_loss \
    --exp_id '0828/4obj-loadchairs-fine256-144scenes' \
