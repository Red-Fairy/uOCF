...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 20 --n_img_each_scene 1 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/kitchen-easy/uORF-4obj-intrinsics-QBO-2' \
    --load_epoch 1444 --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --coarse_epoch 0 --niter 10000 --no_locality_epoch 0 --z_dim 96 --num_slots 5 --near 6 --far 20 \
    --model 'uorf_nogan' --bottom --fixed_locality --learnable_slot_init \
    --exp_id 'uORF-4obj-intrinsics-QBO-zeroshot-20-oneview' \
# done
echo "Done"
