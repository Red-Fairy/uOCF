...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/kitchen-hard/4obj-tabletop-train'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 270 --n_img_each_scene 2 \
    ...
    --exp_id 'dataset-tabletop/4obj-load4obj-fastDecay' \
