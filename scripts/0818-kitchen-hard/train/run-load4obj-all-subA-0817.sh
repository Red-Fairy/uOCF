...
DATAROOT=${1:-'/svl/u/redfairy/datasets/real/kitchen-hard/4obj-tabletop-subA-train'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 135 --n_img_each_scene 2 \
    ...
    --coarse_epoch 1500 --niter 3000 --percept_in 200 --no_locality_epoch 0 --seed 2025 \
    ...
    --exp_id 'dataset-tabletop/4obj-load4obj-subA' \
