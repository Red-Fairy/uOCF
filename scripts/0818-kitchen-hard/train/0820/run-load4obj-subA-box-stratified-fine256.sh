...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 225 --n_img_each_scene 2 \
    ...
    --coarse_epoch 750 --niter 2500 --percept_in 150 --no_locality_epoch 0 --seed 2025 \
    ...
    --dense_sample_epoch 300 --stratified --fg_object_size 3 --n_dense_samp 256 \
    --exp_id '0820/4obj-load4obj-subA-box-stratified-fine256' \
