...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 225 --n_img_each_scene 2 \
    ...
    --load_size 128 --n_samp 64 --frustum_size_fine 128 \
    ...
    --coarse_epoch 750 --niter 2500 --percept_in 250 --no_locality_epoch 0 --seed 2025 \
    ...
    --fixed_locality \
    --dense_sample_epoch 500 --stratified --fg_object_size 3 --n_dense_samp 256 --keep_ratio 0 \
    --exp_id '0820/4obj-loadchairs-subA-box-stratified-fine128' \
