...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/room_diverse_nobg/train-1obj-singlesize-white'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 4  \
    ...
    --project \
    --coarse_epoch 120 --niter 120 --percept_in 10 \
    --exp_id '0507-mask-1obj-scale3.5-singleSize' \
