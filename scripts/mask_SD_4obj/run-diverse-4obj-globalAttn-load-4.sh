...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3  \
    ...
    --attn_decay_steps 150000 --freezeInit_ratio 0.2 --freezeInit_steps 50000 \
    ...
    --exp_id '0515-bg-SD/attn-scratch-4obj-load-freeze0.2-init10' \
    --dummy_info 'slot attention, train from scratch, light to_res_fg and to_res_bg, freeze init ratio 0.2, freeze 10 epoch' \
