...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3  \
    ...
    --attn_decay_steps 150000 --freezeInit_ratio 1 \
    ...
    --exp_id '0515-bg-SD/attn-scratch-4obj-load-freeze1' \
    --dummy_info 'slot attention, train from scratch, light to_res_fg and to_res_bg, scale=4, freeze init ratio 1 ' \
