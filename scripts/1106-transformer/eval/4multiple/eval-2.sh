...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/ABO-multiple/test-2-4obj-4050'}
PORT=${2:-12783}
...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1211-DINONormModMLP/4obj-load-removeDup-r2' \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --camera_modulation --camera_normalize --scaled_depth --depth_scale 12.2 --bg_rotate \
    --vis_attn --vis_mask --vis_render_disparity --remove_duplicate \
