...
CUDA_VISIBLE_DEVICES=0 python test-slot-video.py --dataroot $DATAROOT --n_scenes 56 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --wanted_indices '4' --video_mode 'spherical' \
