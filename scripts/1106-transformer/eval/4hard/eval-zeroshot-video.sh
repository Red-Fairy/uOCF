...
CUDA_VISIBLE_DEVICES=1 python test-video.py --dataroot $DATAROOT --n_scenes 1 --start_scene_idx 0 --n_img_each_scene 1  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/kitchen-hard/1220-loadMult/zeroshot' \
    --epoch 1000 \
    ...
    --video --video_mode 'spiral' --no_loss \
