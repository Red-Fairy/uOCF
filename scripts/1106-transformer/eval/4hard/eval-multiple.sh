...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 56 --start_scene_idx 0 --n_img_each_scene 2  \
    ...
    --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/kitchen-hard/1220-loadMult/full-dataset-bleed' \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --camera_modulation --camera_normalize --scaled_depth \
    --depth_scale_pred --depth_scale 12.2 --bg_rotate \
    --vis_attn --vis_render_mask --recon_only \
    --dummy_info '' --testset_name 'eval_kithard' \
