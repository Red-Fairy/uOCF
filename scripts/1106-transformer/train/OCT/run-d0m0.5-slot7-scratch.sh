...
DATAROOT=${1:-'/svl/u/redfairy/datasets/OSTScene/trainA'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 3000 --n_img_each_scene 3 \
    ...
    --coarse_epoch 100 --niter 200 --percept_in 40 --no_locality_epoch 20 --seed 2023 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 100 --n_feat_layers 4 \
    --near 1.5 --far 6.0 --nss_scale 4.0 --fg_object_size 1.5 --obj_scale 2.5 \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'learnable' \
    --load_intrinsics --predict_depth_scale \
    --exp_id '1202/load-d0m0.5-slot7-scratch' \
