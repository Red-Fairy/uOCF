...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1 --n_img_each_scene 3 \
    ...
    --num_slots 2 --attn_iter 6 --shape_dim 72 --color_dim 24 \
    --coarse_epoch 100000 --niter 200000 --percept_in 40000 --no_locality_epoch 50000 --seed 2023 \
    --stratified --fixed_locality --dense_sample_epoch 100000 --n_feat_layers 4 \
    --near 1.5 --far 9.0 --nss_scale 2.5 --fg_object_size 0.75 --obj_scale 0 \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' --one2four \
    --load_intrinsics --scaled_depth --depth_scale 1.5 \
    --exp_id '1202/load-d0m0.5-slot2-BGdebug' \
