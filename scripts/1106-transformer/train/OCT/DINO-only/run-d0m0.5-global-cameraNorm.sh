...
DATAROOT=${1:-'/svl/u/redfairy/datasets/OSTScene/train-A-img4-res256'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 3000 --n_img_each_scene 3 \
    ...
    --num_slots 8 --attn_iter 6 --shape_dim 32 --color_dim 32 \
    ...
    --n_feat_layers 1 --global_bg_feat --camera_normalize \
