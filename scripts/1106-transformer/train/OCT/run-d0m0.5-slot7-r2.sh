...
DATAROOT=${1:-'/svl/u/redfairy/datasets/OSTScene/train-A'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 3000 --n_img_each_scene 3 \
    ...
    --stratified --fixed_locality --dense_sample_epoch 100 --n_feat_layers 4 \
    ...
    --load_intrinsics --scaled_depth --depth_scale 4.0 \
    --exp_id '1202/load-d0m0.5-slot7-r3' \
