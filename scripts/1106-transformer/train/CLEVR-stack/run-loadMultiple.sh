...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 200 --niter 400 --percept_in 50 --no_locality_epoch 100 --seed 2027 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 100 --n_feat_layers 1 \
    ...
    --vis_mask \
    --exp_id '1222-noplane/4obj-loadMultiple' \
