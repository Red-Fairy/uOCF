...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 2 \
    ...
    --attn_decay_steps 100000 --warmup_steps 0 --obj_scale 5 --bottom \
    --encoder_size 896 --encoder_type 'DINO' \
    --num_slots 2 --attn_iter 6 --shape_dim 48 --color_dim 48 \
    --coarse_epoch 200 --niter 200 --percept_in 20 --no_locality_epoch 100 --seed 2023 \
