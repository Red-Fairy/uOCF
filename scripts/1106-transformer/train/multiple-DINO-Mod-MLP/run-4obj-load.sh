...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1211-DINOModMLP/1obj-d0m0.5-cam-r1' \
    ...
    --exp_id '1211-DINOModMLP/4obj-load-cam' \
    --dummy_info '' \
