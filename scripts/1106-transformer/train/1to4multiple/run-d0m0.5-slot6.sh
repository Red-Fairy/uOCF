...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/ABO-multiple/train-2-4obj'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --num_slots 6 --attn_iter 6 --shape_dim 72 --color_dim 24 \
    ...
    --exp_id '1122-2-4obj/load-d0m0.5-slot6' \
