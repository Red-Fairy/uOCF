...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --num_slots 5 --attn_iter 8 --shape_dim 48 --color_dim 16 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1121-1obj/1obj-d0m0.5-d64-attn8' \
    ...
    --exp_id '1122-2-4obj/load-d0m0.5-d64-attn8' \
