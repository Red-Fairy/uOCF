...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 300 --niter 600 --percept_in 75 --no_locality_epoch 200 --seed 2025 \
    ...
    --remove_duplicate --pseudo_mask_loss --pseudo_mask_in 150 --pseudo_mask_loss_type 'cosine' \
    --vis_mask \
    --exp_id '1220-loadMult/full-dataset-r5' \
