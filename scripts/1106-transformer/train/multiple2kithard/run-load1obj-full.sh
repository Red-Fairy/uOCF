...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 300 --niter 600 --percept_in 75 --no_locality_epoch 200 --seed 2024 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 200 --n_feat_layers 1 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1220-predDepthScale/1obj-r2' \
    --load_epoch 100 --one2four \
    ...
    --remove_duplicate --pseudo_mask_loss --pseudo_mask_in 0 --pseudo_mask_loss_type 'cosine' \
    --vis_mask \
    --exp_id '1220-loadMult/full-dataset-load1obj' \
