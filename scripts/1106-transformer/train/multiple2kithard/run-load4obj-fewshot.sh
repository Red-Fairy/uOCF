...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 10 --n_img_each_scene 2 \
    ...
    --attn_decay_steps 10000 --bottom \
    --encoder_size 896 --encoder_type 'DINO' \
    --num_slots 5 --attn_iter 6 --shape_dim 48 --color_dim 48 \
    --coarse_epoch 2000 --niter 4000 --percept_in 400 --no_locality_epoch 800 --seed 2027 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 800 --n_feat_layers 1 \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1220-predDepthScale/4obj-load-removeDup-range0.25' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_train' \
    --exp_id '1220-loadMult/fewshot' --vis_mask \
