...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 30 --niter 60 --percept_in 5 --no_locality_epoch 20 --seed 2025 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 10 --n_feat_layers 2 \
    --bg_density_loss --bg_density_in 20 \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'zero' \
    --exp_id '1207-dualDINO/4obj-scratch-d0m0.5-layer2' \
