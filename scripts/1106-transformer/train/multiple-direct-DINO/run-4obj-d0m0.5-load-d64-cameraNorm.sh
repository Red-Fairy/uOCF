...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --num_slots 5 --attn_iter 6 --shape_dim 32 --color_dim 32 \
    --coarse_epoch 50 --niter 100 --percept_in 10 --no_locality_epoch 20 --seed 2025 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 30 --n_feat_layers 1 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1207-dualDINO/1obj-d0m0.5-cameraNorm' \
    ...
    --camera_normalize --scaled_depth --depth_scale 12.2 \
    --exp_id '1207-dualDINO/4obj-load-d0m0.5-d64-cameraNorm' \
