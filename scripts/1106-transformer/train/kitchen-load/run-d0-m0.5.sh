...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/room_ABO_multiple/1121-1obj/1obj-d0m0.5-4050' \
    ...
    --exp_id '1121/4obj-load-d0-m0.5-r2' \
