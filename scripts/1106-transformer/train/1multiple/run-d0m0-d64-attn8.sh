...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 4000 --n_img_each_scene 2 \
    ...
    --display_port $PORT --display_ncols 4 --print_freq 50 --display_freq 50 --save_epoch_freq 7 \
    ...
    --num_slots 2 --attn_iter 8 --shape_dim 48 --color_dim 16 \
    ...
    --attn_dropout 0 --attn_momentum 0 --pos_init 'zero' \
    --exp_id '1121-1obj/1obj-d0m0-d64-attn8' \
