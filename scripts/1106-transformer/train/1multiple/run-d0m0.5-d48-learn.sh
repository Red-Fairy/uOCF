...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 4000 --n_img_each_scene 2 \
    ...
    --num_slots 2 --attn_iter 6 --shape_dim 36 --color_dim 12 \
    --coarse_epoch 200 --niter 200 --percept_in 8 --no_locality_epoch 15 --seed 2023 \
    --stratified --fixed_locality --fg_object_size 3 --n_feat_layers 4 \
    --attn_dropout 0 --attn_momentum 0.5 --pos_init 'learnable' \
    --exp_id '1121-1obj/1obj-d0m0.5-d48-learn' \
