...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/ABO-multiple/train-2-7obj-mdist'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 60 --niter 120 --percept_in 10 --no_locality_epoch 37 --seed 2027 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 37 --n_feat_layers 1 \
    ...
    --remove_duplicate --remove_duplicate_in 30 --vis_mask \
    --scaled_depth --camera_modulation --camera_normalize --bg_rotate \
    --exp_id '1224-2-7obj/load-extrinsicDepth' \
    --continue_train --epoch_count 102 \
    --dummy_info '' \
