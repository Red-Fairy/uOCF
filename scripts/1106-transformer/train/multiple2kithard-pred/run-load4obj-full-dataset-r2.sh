...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --num_slots 6 --attn_iter 6 --shape_dim 48 --color_dim 48 \
    --coarse_epoch 300 --niter 600 --percept_in 50 --no_locality_epoch 200 --seed 2024 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 200 --n_feat_layers 1 \
    ...
    --remove_duplicate --pseudo_mask_loss --pseudo_mask_in 250 --pseudo_mask_loss_type 'cosine' \
    --vis_mask \
    --exp_id '1220-loadMult/full-dataset-6slots-r2' \
