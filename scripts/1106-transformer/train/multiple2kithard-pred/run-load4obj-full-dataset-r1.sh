...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --coarse_epoch 350 --niter 600 --percept_in 75 --no_locality_epoch 250 --seed 2024 \
    ...
    --remove_duplicate --pseudo_mask_loss --pseudo_mask_in 225 --pseudo_mask_loss_type 'cosine' --weight_pseudo_mask 0.02 \
    --vis_mask \
    --continue_train --epoch 200 --epoch_count 201 \
    --exp_id '1220-loadMult/full-dataset-r3' \
