...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/ABO-multiple/train-2-4obj-4050-mdist'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 2 \
    ...
    --coarse_epoch 50 --niter 100 --percept_in 20 --no_locality_epoch 20 --seed 2027 \
    ...
    --exp_id '1122-4obj/4obj-scratch-d0-m0.5-mdist-r2' \
