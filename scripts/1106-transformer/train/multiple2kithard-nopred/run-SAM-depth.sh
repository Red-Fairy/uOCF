...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --attn_decay_steps 100000 --lr 0.0002 \
    --encoder_size 896 --encoder_type 'DINO' \
    --num_slots 5 --attn_iter 6 --shape_dim 48 --color_dim 48 \
    --coarse_epoch 500 --niter 800 --percept_in 75 --no_locality_epoch 150 --seed 2024 \
    ...
    --camera_normalize --camera_modulation --bg_rotate --scaled_depth --depth_scale 12.2 \
    --remove_duplicate --pseudo_mask_loss --pseudo_mask_in 420 --pseudo_mask_loss_type 'cosine' --weight_pseudo_mask 0.004 \
    --vis_mask \
    --continue_train --epoch 400 --epoch_count 401 \
    --exp_id '1225-DINONormModMLP/4obj-load-SAM-depth-r2' \
