...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --remove_duplicate --pseudo_mask_loss --pseudo_mask_in 400 --pseudo_mask_loss_type 'cosine' --weight_pseudo_mask 0.004 \
    --vis_mask \
    --train_dec_only_epoch 400 \
    --continue_train --epoch 400 --epoch_count 401 \
    --exp_id '1225-DINONormModMLP/4obj-load-SAM-depth-freeze' \
