...
DATAROOT=${1:-'/svl/u/redfairy/datasets/bridgeV2/formatted/scene_02_03'}
PORT=${2:-12783}
python -m visdom.server -p $PORT &>/dev/null &
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1020 --n_img_each_scene 1 \
    --checkpoints_dir 'checkpoints' --name 'bridge' \
    --display_port $PORT --display_ncols 4 --print_freq 51 --display_freq 51 --save_epoch_freq 100 \
    --load_size 128 --n_samp 128 --input_size 128 --supervision_size 64 --frustum_size 64 \
    --model 'uocf_dual_DINO_trans' \
    --attn_decay_steps 100000 --freezeInit_steps 10000 --lr 0.0003 --load_intrinsics \
    ...
    --vis_mask \
    --exp_id '1228-debut/7obj-load-single' \
