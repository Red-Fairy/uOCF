...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 10 --n_img_each_scene 2 \
    ...
    --coarse_epoch 5000 --niter 4000 --percept_in 1000 --no_locality_epoch 2000 --seed 2027 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/uOCF/checkpoints/OCTScenes/1212-modNorm/load-d0m0.5-cameraNorm-r2' \
