...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 200 --n_img_each_scene 4  \
    ...
    --transparent  --mask_in 0 --bg_color -1 --surface_loss --obj_scale 3 --fg_in_world \
    --exp_id '0516-DINO/maskfg-1obj-1shape-fgworld' \
    --dummy_info 'mask fg scale=3, moving FG position, global attention, locality out, vitb, fg_in_world' \
