...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 745 --n_img_each_scene 3 \
    ...
    --display_port $PORT --display_ncols 4 --print_freq 149 --display_freq 149 --save_epoch_freq 10 \
    ...
    --exp_id '0906-IPE/4obj-loadchairs-fine256' \
    --continue_train --epoch 780 --epoch_count 781 \
