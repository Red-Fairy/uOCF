...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 745 --n_img_each_scene 3 \
    ...
    --continue_train --epoch 220 --epoch_count 221 --stratified --fg_object_size 2.8 --n_dense_samp 128 \
    --exp_id '0820/4obj-load4obj-ttt-box-stratified-0keep' --keep_ratio 0 \
