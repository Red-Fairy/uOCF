...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 745 --n_img_each_scene 3 \
    ...
    --load_size 128 --n_samp 128 --input_size 128 --frustum_size_fine 128 \
    ...
    --coarse_epoch 250 --niter 1000 --percept_in 50 --no_locality_epoch 0 --seed 2025 \
    ...
    --exp_id '0820/4obj-loadchairs-ttt-box-stratified-IPE' \
