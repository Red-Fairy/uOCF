...
CUDA_VISIBLE_DEVICES=0 python train_without_gan.py --dataroot $DATAROOT --n_scenes 745 --n_img_each_scene 2 \
    ...
    --continue_train --epoch_count 275 --stratified --fg_object_size 3 --n_dense_samp 256 \
    --exp_id '0820/4obj-load4obj-ttt-box-stratified-fine256' --keep_ratio 0 \
    --dummy_info 'DINO load from 4 obj synthetic, 160 epoch, keep ratio=0' \
