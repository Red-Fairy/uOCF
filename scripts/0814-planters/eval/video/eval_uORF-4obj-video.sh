...
PORT=${2:-12783}
CUDA_VISIBLE_DEVICES=0 python test-video.py --dataroot $DATAROOT --n_scenes 140 --n_img_each_scene 1 \
    ...
    --attn_iter 3 --testset_name 'test_video' --video --recon_only --no_loss \
# done
echo "Done"