...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1296 --n_img_each_scene 4 \
    ...
    --num_slots 2 --attn_iter 4 --shape_dim 48 --shape_dim 16 \
    --coarse_epoch 80 --niter 160 --percept_in 20 --no_locality_epoch 40 --seed 2025 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 20 \
    --n_layer 8 \
    --exp_id '1031/1obj-scratch-8layer' \
