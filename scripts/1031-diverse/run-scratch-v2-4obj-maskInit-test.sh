...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4 \
    ...
    --num_slots 5 --attn_iter 4 --shape_dim 48 --shape_dim 16 \
    --coarse_epoch 4000 --niter 8000 --percept_in 1000 --no_locality_epoch 0 --seed 2025 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 1000 \
    --n_feat_layers 8 --mask_init_position \
    --exp_id '1031/4obj-scratch-8layer-maskInit-test' \
