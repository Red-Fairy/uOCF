...
CUDA_VISIBLE_DEVICES=0 python test-slot-video.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4 \
    ...
    --n_samp 256 --z_dim 64 --num_slots 5 --near 8 --far 18 --bottom \
    --model 'uorf_eval' \
    --pos_emb --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_diverse_bg/ablation/uORF-4obj-GAN' \
    --attn_iter 3 --testset_name 'test_video_slot' --epoch 240 \
# done
echo "Done"