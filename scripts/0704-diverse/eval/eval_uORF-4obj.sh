...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4 \
    ...
    --load_size 128 --input_size 128 --render_size 32 --frustum_size 128 --bottom \
    --n_samp 256 --z_dim 64 --num_slots 5 \
    --model 'uorf_eval' \
    --pos_emb --exp_id '/viscam/projects/uorf-extension/uOCF/checkpoints/room_diverse_bg/ablation/uORF-4obj' \
    --attn_iter 3 --testset_name 'test-2-4obj' \
# done
echo "Done"