...
python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4  \
    ...
    --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_diverse_bg/0703/4obj-loadPos-ttf-r2' \
    --dummy_info 'regular test' --testset_name 'regular_160end-sample256' --epoch 160 \
