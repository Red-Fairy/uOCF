...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot $DATAROOT --n_scenes 100 --n_img_each_scene 4 \
    ...
    --n_samp 256 --z_dim 64 --shape_dim 48 --color_dim 16 --num_slots 8 --near 8 --far 18 \
    --model 'uorf_eval_DINO' \
    --bottom --encoder_type 'DINO' --encoder_size 896 --dual_route_encoder \
    --pos_emb --exp_id '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_diverse_bg/ablation/uORF-4obj-DINO-dualroute' \
