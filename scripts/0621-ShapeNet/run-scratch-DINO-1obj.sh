...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 500 --n_img_each_scene 3 \
    ...
    --coarse_epoch 1000 --niter 2000 --percept_in 50 --no_locality_epoch 100 \
    --exp_id '0621/1obj-scratch' \
