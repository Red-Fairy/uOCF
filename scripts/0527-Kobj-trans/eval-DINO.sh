...
DATAROOT=${1:-'/viscam/projects/uorf-extension/datasets/room_diverse_nobg/train-1obj-1200-uncenter'}
PORT=${2:-12783}
...
python test.py --dataroot $DATAROOT --n_scenes 20 --n_img_each_scene 8  \
    ...
    --model 'uorf_general_mask_Kobj_eval' \
    ...
    --bg_color '-1' \
    --exp_id '0527-ProofOfConcepts/load-DINO-learn1obj-pos-freeze-r2' \
