...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_diverse_bg/0609-4obj/1obj-scratch' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --sis_loss --sis_loss_weight 0.1 \
    --exp_id '0609-4obj/load-DINO-4obj-sis' \
