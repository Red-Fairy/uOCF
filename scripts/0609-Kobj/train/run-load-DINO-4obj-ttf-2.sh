...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4 \
    ...
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/room_diverse_bg/0609/1obj-load-uuf' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --exp_id '0609/load-DINO-4obj-r2' \
    --dummy_info 'load DINO (1 obj uuf ~380epoch), lr 1e-4' \
