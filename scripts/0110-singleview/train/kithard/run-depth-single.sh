...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 828 --n_img_each_scene 2 \
    ...
    --coarse_epoch 500 --niter 1000 --percept_in 75 --no_locality_epoch 150 --seed 2023 \
    ...
    --camera_normalize --camera_normalize_mode 'left' \
    --camera_modulation --bg_rotate --scaled_depth --depth_scale 12.2 --fixed_dist 12.2 \
    --multiview_loss --multiview_in 100 \
    --exp_id 'kithard/left-r1' \
