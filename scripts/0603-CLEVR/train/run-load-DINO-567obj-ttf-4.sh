...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 4 \
    ...
    --coarse_epoch 400 --niter 800 --percept_in 100 --no_locality_epoch 100 \
    ...
    --exp_id '0609/load-DINO-567obj-fft-r4' \
    --dummy_info 'load DINO from 1 obj (uuf, 400epoch), frozen decoder for 50000 steps, lr 1e-4' \
