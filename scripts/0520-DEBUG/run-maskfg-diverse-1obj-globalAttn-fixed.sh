...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4  \
    ...
    --bg_color '-1' --fixed_locality \
    --exp_id '0521-DEBUG/simulate-0508-globalAttn-dualfeat-fixed' \
    --save_epoch_freq 2 \
    --dummy_info 'mask fg scale-3.5, light, fixed FG position, global attention, calculate locality before transform, fixed locality' \
