...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 324 --n_img_each_scene 2 \
    ...
    --learnable_init_pos --attn_momentum 0 --num_anchors 4 \
    --bg_density_loss --bg_density_in 150 --position_loss --position_in 150 --dropout 0 \
    --exp_id '1108/4obj-momentum0-attn4-noDrop' \
