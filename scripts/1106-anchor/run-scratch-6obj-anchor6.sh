...
DATAROOT=${1:-'/svl/u/redfairy/datasets/room-real/chairs/train-6obj'}
PORT=${2:-12783}
...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 3 \
    ...
    --num_slots 7 --attn_iter 6 --shape_dim 48 --color_dim 16 \
    --coarse_epoch 40 --niter 80 --percept_in 10 --no_locality_epoch 10 --seed 2023 \
    --stratified --fixed_locality --fg_object_size 3 --dense_sample_epoch 10 --n_feat_layers 4 \
    --learnable_init_pos --attn_momentum 0.5 --num_anchors 6 \
    --exp_id '1106/6obj-anchor6' \
