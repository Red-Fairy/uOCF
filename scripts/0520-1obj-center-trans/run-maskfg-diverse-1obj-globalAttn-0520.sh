...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4  \
    ...
    --project \
    --coarse_epoch 60 --niter 60 --percept_in 10 --locality_in 10 --locality_full 20 \
    --attn_decay_steps 100000 --save_epoch_freq 10 \
    --transparent  --mask_in 0 --bg_color -1 --world_obj_scale 4 --obj_scale 2.5 \
    --exp_id '0520-DEBUG/maskfg-SD' \
    --dummy_info 'moving FG position, decay locality' \
