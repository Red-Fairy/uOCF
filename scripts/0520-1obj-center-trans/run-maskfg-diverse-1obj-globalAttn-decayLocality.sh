...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 5000 --n_img_each_scene 4  \
    ...
    --project \
    --coarse_epoch 60 --niter 60 --percept_in 10 --locality_in 10 --locality_full 10 \
    --attn_decay_steps 100000 \
    --bg_color '-1' \
    --exp_id '0521-DEBUG/simulate-0508-globalAttn-dualfeat-decayLocality' \
    --continue_train --epoch_count 15 \
    --save_epoch_freq 2 \
