...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 4 \
    ...
    --num_slots 8 --attn_iter 4 --shape_dim 16 --color_dim 16 \
    --coarse_epoch 400 --niter 800 --percept_in 100 --no_locality_epoch 0 --seed 2023 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/clevr_bg/0728/1obj-scratch-pos-CIT' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --color_in_attn \
    --exp_id '0728/567obj-loadScratchPos-ttf-CIT' \
    --dummy_info 'load DINO from 1 obj (scratch), CIT, freeze decoder for 50000 steps' \
