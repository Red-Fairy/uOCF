...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 1000 --n_img_each_scene 4 \
    ...
    --coarse_epoch 400 --niter 800 --percept_in 100 --no_locality_epoch 200 --seed 2023 \
    --load_pretrain --load_pretrain_path '/viscam/projects/uorf-extension/I-uORF/checkpoints/clevr_bg/0703/1obj-scratch-pos' \
    --load_encoder 'load_train' --load_slotattention 'load_train' --load_decoder 'load_freeze' \
    --exp_id '0703/loadScratchPos-567obj-ttf' \
    --dummy_info 'load DINO from 1 obj (scratch), freeze decoder for 50000 steps' \
